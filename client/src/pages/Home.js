    ...
    <Layout>
      ...
      <header className="container mx-auto px-4 py-6">
        ...
        {isMenuOpen && (
          <nav className="mt-4 md:hidden">
            <NavLink to="/register" className="btn btn-primary mr-3"><button className="block w-full text-left px-4 py-2 text-blue-600 hover:bg-blue-50 rounded transition-colors">
              Sign Up
            </button></NavLink>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Welcome to College Marketplace</h2>
